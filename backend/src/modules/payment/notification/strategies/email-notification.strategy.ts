...
/**
 * Kênh email — cùng in-app là 2 kênh duy nhất triển khai cho domain thanh toán (§0, §1).
 * Bỏ qua (không lưu bản ghi lỗi giả) nếu payload không có sẵn `recipient.email` — dispatcher
 * chịu trách nhiệm resolve email trước khi gọi, strategy không tự tra cứu quan hệ Patient/User.
 */
@Injectable()
